<template>
  <div class="app-title">
    ...
    <van-field
      style="display: none;"
      name="hasUpdate"
      v-model="projpcontractreviewupdateform.hasUpdate"
      type="text"
      readonly
    />
    <van-field
      style="display: none;"
      name="id"
      v-model="projpcontractreviewupdateform.id"
      type="text"
      readonly
    />
    <van-field
      style="display: none;"
      name="meetingUsers"
      v-model="projpcontractreviewupdateform.meetingUsers"
      type="text"
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.bizId"
      label="合同号"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否已投标备案"
      v-model="projpcontractreviewupdateform.isRecord"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      v-model="projpcontractreviewupdateform.chanceId"
      type="text"
      label="商机编号"
      colon
      readonly
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.name"
      label="合同名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.recordId"
      label="投标备案编号"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.reqUserName"
      label="申请人"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否关联交易"
      v-model="projpcontractreviewupdateform.isRelated"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      v-model="projpcontractreviewupdateform.contractTypeDesc"
      type="text"
      label="合同类别"
      colon
      readonly
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.leadOrgName"
      label="主导部门"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.projectName"
      label="项目名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.companyText"
      label="签订公司"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.customerName"
      label="客户名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.saleManName"
      label="销售人员"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.salesManOrgName"
      label="销售人员部门"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.pmManagerName"
      label="项目经理"
      colon
      readonly
    />
    <van-field
      type="text"
      style="display: none"
      name="his_pmManagerName"
      v-model="projpcontractreviewupdateform.pmManagerName"
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.operationStartTime"
      label="运维开始时间"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      style="display: none"
      name="his_operationEndTime"
      v-model="projpcontractreviewupdateform.operationEndTime"
      readonly
    />
    <van-field
      type="text"
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.bizId"
      label="合同号"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否已投标备案"
      v-model="affterProjpcontractreviewupdateform.isRecord"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      v-model="affterProjpcontractreviewupdateform.chanceId"
      type="text"
      label="商机编号"
      colon
      readonly
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.name"
      label="合同名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.recordId"
      label="投标备案编号"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.reqUserName"
      label="申请人"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否关联交易"
      v-model="affterProjpcontractreviewupdateform.isRelated"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      v-model="affterProjpcontractreviewupdateform.contractTypeDesc"
      type="text"
      label="合同类别"
      colon
      readonly
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.leadOrgName"
      label="主导部门"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.projectName"
      label="项目名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.companyText"
      label="签订公司"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.customerName"
      label="客户名称"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.saleManName"
      label="销售人员"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.salesManOrgName"
      label="销售人员部门"
      colon
      readonly
    />
    <van-field
      type="text"
      name="pmManagerName"
      v-model="affterProjpcontractreviewupdateform.pmManagerName"
      label="项目经理"
      colon
      readonly
    />
    <van-field
      ...
      v-model="affterProjpcontractreviewupdateform.operationStartTime"
      label="运维开始时间"
      colon
      readonly
    />
    <van-field
      ...
      v-model="affterProjpcontractreviewupdateform.operationEndTime"
      label="运维结束时间"
      colon
      readonly
    />
    <div>
      ...
      <van-field
        type="text"
        v-model="projpcontractreviewupdateform.contractAmount"
        label="金额合计"
        colon
        readonly
      />
    ...
    <div>
      ...
      <van-field
        type="text"
        v-model="affterProjpcontractreviewupdateform.contractAmount"
        label="金额合计"
        colon
        readonly
      />
    ...
    <div>
      ...
      <van-field
        type="text"
        v-model="projpcontractreviewupdateform.costTotalAmount"
        label="金额合计"
        colon
        readonly
      />
    ...
    <div>
      ...
      <van-field
        type="text"
        v-model="affterProjpcontractreviewupdateform.costTotalAmount"
        label="金额合计"
        colon
        readonly
      />
    ...
    <div>
      ...
      <van-field
        type="text"
        v-model="projpcontractreviewupdateform.occupy"
        label="资金占用情况"
        colon
        readonly
      />
    ...
    <div>
      ...
      <van-field
        type="text"
        v-model="affterProjpcontractreviewupdateform.occupy"
        label="资金占用情况"
        colon
        readonly
      />
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.receiveTotalAmount"
      label="收入合计"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      name="projectIncome"
      v-model="projpcontractreviewupdateform.projectIncome"
      label="工程收入"
      colon
      readonly
    />
    <van-field
      ...
      v-model="projpcontractreviewupdateform.freeSftwareIncome"
      label="自有软件收入"
      colon
      readonly
    />
    <van-field
      type="text"
      name="interNalCost"
      v-model="projpcontractreviewupdateform.interNalCost"
      label="内包成本"
      colon
      readonly
    />
    <van-field
      type="text"
      name="bidFeesCost"
      v-model="projpcontractreviewupdateform.bidFeesCost"
      label="中标服务费"
      colon
      readonly
    />
    <van-field
      type="text"
      name="projectCost"
      v-model="projpcontractreviewupdateform.projectCost"
      label="工程成本"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.rService"
      label="技术服务收入"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.purchasingCost"
      label="采购成本"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.subcontractCost"
      label="分包成本"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.grossProfit"
      label="毛利润"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.pretaxGrossProfitRate"
      label="税前毛利润率%"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.aftertaxGrossProfitRate"
      label="税后毛利润率%"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否有项目"
      v-model="projpcontractreviewupdateform.hasProject"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.projcetNo"
      label="项目号"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.netProfit"
      label="净利润"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.tax"
      name="tax"
      label="税金"
      colon
      readonly
    ...
    <van-field
      ...
      v-model="projpcontractreviewupdateform.grossProfitMargin"
      label="毛利润率差值"
      colon
      readonly
    />
    <van-field
      ...
      v-model="projpcontractreviewupdateform.netProfitMargin"
      label="净利润率差值"
      colon
      readonly
    />
    <van-field
      type="text"
      name="netProfitRate"
      v-model="projpcontractreviewupdateform.netProfitRate"
      label="税后净利润率(%)"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.receiveTotalAmount"
      label="收入合计"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      name="projectIncome"
      v-model="affterProjpcontractreviewupdateform.projectIncome"
      label="工程收入"
      colon
      readonly
    />
    <van-field
      type="text"
      name="freeSftwareIncome"
      v-model="affterProjpcontractreviewupdateform.freeSftwareIncome"
      label="自有软件收入"
      colon
      readonly
    />
    <van-field
      type="text"
      name="interNalCost"
      v-model="affterProjpcontractreviewupdateform.interNalCost"
      label="内包成本"
      colon
      readonly
    />
    <van-field
      type="text"
      name="bidFeesCost"
      v-model="affterProjpcontractreviewupdateform.bidFeesCost"
      label="中标服务费"
      colon
      readonly
    />
    <van-field
      type="text"
      name="projectCost"
      v-model="affterProjpcontractreviewupdateform.projectCost"
      label="工程成本"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.rService"
      label="技术服务收入"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.purchasingCost"
      label="采购成本"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.subcontractCost"
      label="分包成本"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.grossProfit"
      label="毛利润"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.pretaxGrossProfitRate"
      label="税前毛利润率%"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.aftertaxGrossProfitRate"
      label="税后毛利润率%"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否有项目"
      v-model="affterProjpcontractreviewupdateform.hasProject"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.projcetNo"
      label="项目号"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.netProfit"
      label="净利润"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.tax"
      label="税金"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      name="grossProfitMargin"
      v-model="affterProjpcontractreviewupdateform.grossProfitMargin"
      label="毛利润率差值"
      colon
      readonly
    />
    <van-field
      type="text"
      name="netProfitMargin"
      v-model="affterProjpcontractreviewupdateform.netProfitMargin"
      label="净利润率差值"
      colon
      readonly
    />
    <van-field
      type="text"
      name="netProfitRate"
      v-model="affterProjpcontractreviewupdateform.netProfitRate"
      label="税后净利润率(%)"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.linkman"
      label="客户联系人"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.phone"
      label="联系人电话"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否有销售合同文件"
      v-model="projpcontractreviewupdateform.hasContract"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      name="radio"
      label="是否为最终客户"
      v-model="projpcontractreviewupdateform.isEndCust"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否签订合同"
      colon
      v-model="projpcontractreviewupdateform.isContract"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      colon
      v-model="projpcontractreviewupdateform.isMixed"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否提前下单"
      colon
      v-model="projpcontractreviewupdateform.hasAdvanceOrder"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否提前发货"
      colon
      v-model="projpcontractreviewupdateform.hasAdvanceSend"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否合作项目"
      colon
      v-model="projpcontractreviewupdateform.hasCooperation"
      readonly
    >
      <template #input>
    ...
    <van-field
      type="text"
      v-model="projpcontractreviewupdateform.signDate"
      label="预计签订时间"
      colon
      readonly
    />
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.linkman"
      label="客户联系人"
      colon
      readonly
    />
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.phone"
      label="联系人电话"
      colon
      readonly
    />
    <van-field
      name="radio"
      label="是否有销售合同文件"
      v-model="affterProjpcontractreviewupdateform.hasContract"
      readonly
      colon
    >
      <template #input>
        ...
        <div
          v-else-if="affterProjpcontractreviewupdateform.hasContract === '0'"
          style="margin: 0;"
        >否</div>
        <div v-else style="margin: 0;">暂无</div>
      </template>
    ...
    <van-field
      name="radio"
      label="是否为最终客户"
      v-model="affterProjpcontractreviewupdateform.isEndCust"
      readonly
      colon
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否签订合同"
      colon
      v-model="affterProjpcontractreviewupdateform.isContract"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否提前下单"
      colon
      v-model="affterProjpcontractreviewupdateform.hasAdvanceOrder"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否提前发货"
      colon
      v-model="affterProjpcontractreviewupdateform.hasAdvanceSend"
      readonly
    >
      <template #input>
    ...
    <van-field
      ...
      label="是否合作项目"
      colon
      v-model="affterProjpcontractreviewupdateform.hasCooperation"
      readonly
    >
      <template #input>
    ...
    <van-field
      type="text"
      v-model="affterProjpcontractreviewupdateform.signDate"
      label="预计签订时间"
      colon
      readonly
    />
      ...
      <van-tabs v-model="active2">
        <van-tab title="变更前">
          ...
          <van-field
            left-icon="star"
            type="text"
            v-model="projpcontractreviewupdateform.score"
            label="评分"
            colon
            readonly
          />
        ...
        <van-tab title="变更后">
          ...
          <van-field
            left-icon="star"
            type="text"
            v-model="affterProjpcontractreviewupdateform.score"
            label="评分"
            colon
            readonly
          />
    ...
    <van-field
      v-model="projpcontractreviewupdateform.remark"
      rows="2"
      name="remark"
      autosize
      label="备注"
